...
export function PricingSection() {
  ...
  return (
          ...
          <div className="bg-[#0B0F17] p-8 md:p-12 rounded-[32px] border border-white/5 flex flex-col justify-center">
            ...
            <ul className="space-y-6">
              {bonusItems.map((item) => (
                <li
                  key={item.id}
                  className="flex items-center gap-4 text-gray-400 dark:text-gray-300 text-sm"
                >
                  <svg
                    width="14"
                    height="15"
    ...
    after:rounded-full"
                ...
                <span className="bg-blue-600 text-[10px] font-normal text-white px-3 py-1 rounded-2xl uppercase">
                  30% off
                </span>
              </div>

              <p className="text-gray-300 text-xs font-normal mb-10">
